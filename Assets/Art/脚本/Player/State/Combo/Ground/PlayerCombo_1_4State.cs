...
public class PlayerCombo_1_4State : PlayerGroundComboState
{
    private PlayerComboConfi comboConfi;
    private bool preInput;
    public PlayerCombo_1_4State(PlayerManager _playerManager, string _animationName, bool _useRootMotionPart) : base(_playerManager, _animationName, _useRootMotionPart)
    {
    }
    ...
    public override void Update()
    {
        ...
        if (stateInfo.IsName(animationName))
        {
            ...
            if (stateInfo.normalizedTime > comboConfi.nextComboTime)
            {
                ...
                {
                    //切换下一个连击姿态
                    ChangeState(playerManager.combo_1_5State);
                    playerManager.animator.CrossFade(playerManager.combo_1_5State.animationName, 0.05f);
                }
            }
