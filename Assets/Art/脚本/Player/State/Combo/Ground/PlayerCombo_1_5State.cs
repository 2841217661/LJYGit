...
public class PlayerCombo_1_5State : PlayerGroundComboState
{
    private PlayerComboConfi comboConfi;
    private bool preInput;
    public PlayerCombo_1_5State(PlayerManager _playerManager, string _animationName, bool _useRootMotionPart) : base(_playerManager, _animationName, _useRootMotionPart)
    {
    }
        ...
        if (stateInfo.IsName(animationName))
        {
            ...
            if (stateInfo.normalizedTime > comboConfi.nextComboTime)
            {
                ...
                if (playerManager.playerInputManager.Mouse0DownInput() || preInput)
                {
                    ...
                    playerManager.animator.CrossFade(playerManager.combo_1_1State.animationName, 0.05f);
                }
            }
