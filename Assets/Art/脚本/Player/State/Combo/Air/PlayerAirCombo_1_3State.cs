...
public class PlayerAirCombo_1_3State : PlayerAirComboState
{
    ...
    public PlayerAirCombo_1_3State(PlayerManager _playerManager, string _animationName, bool _useRootMotionPart) : base(_playerManager, _animationName, _useRootMotionPart)
    {
    }
    ...
    public override void Update()
    {
        ...
        else if (stateInfo.IsName(animationName))
        {
            ...
            if (stateInfo.normalizedTime > comboConfi.nextComboTime)
            {
                ...
                {
                    //切换下一个连击姿态
                    ChangeState(playerManager.airCombo_1_4State);
                    //SetRotateDir(playerManager.airCombo_1_4State);
                    playerManager.animator.CrossFade(playerManager.airCombo_1_4State.animationName, 0.05f);
                }
