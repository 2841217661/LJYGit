...
public class PlayerAirCombo_1_4State : PlayerAirComboState
{
    private PlayerComboConfi comboConfi;
    private bool preInput;
    public PlayerAirCombo_1_4State(PlayerManager _playerManager, string _animationName, bool _useRootMotionPart) : base(_playerManager, _animationName, _useRootMotionPart)
    {
    }
        ...
        if (stateInfo.IsName(animationName))
        {
            ...
            if (stateInfo.normalizedTime > comboConfi.nextComboTime)
            {
                ...
                if (playerManager.playerInputManager.Mouse0DownInput() || preInput)
                {
                    ...
                    playerManager.animator.CrossFade(playerManager.airCombo_1_1State.animationName, 0.05f);
                }
            }
